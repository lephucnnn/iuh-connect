                        ...
                        <div class=" form">
                            <form class="form-horizontal " enctype="multipart/form-data" method="post">
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-6">
                                        <input class=" form-control" id="cname" name="ten_lop" minlength="2" type="text" required="">
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="cname" class="control-label col-lg-3">Niên khóa</label>
                                    <div class="col-lg-6">
                                        <input class=" form-control" id="cname" name="nien_khoa" minlength="2" type="text" required="">
                                    </div>
                                </div>
                                <div class="form-group">
